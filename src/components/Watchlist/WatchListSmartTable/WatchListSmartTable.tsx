...
import WatchListSmartTableRow from "src/components/Watchlist/WatchListSmartTable/WatchListSmartTableRow";

const WatchListSmartTable = ({data}) => {
...
export default WatchListSmartTable;
